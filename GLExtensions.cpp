...
{
    if (vendor) mVendor     = (char const*)vendor;
    if (renderer) mRenderer   = (char const*)renderer;
    if (version) mVersion    = (char const*)version;
    if (extensions) mExtensions = (char const*)extensions;
